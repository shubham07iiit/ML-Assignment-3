...
print(max_index)
plt.figure()
plt.title("Image Data - Neural Network Accuracy curve with PCA")
plt.xlabel("No Of Components")
...
plt.title("ImageData PCA - Kmeans + GMM Accuracy curve with number of clusters")
...
plt.figure()
plt.xticks(list(range(1,30)))
plt.title("ImageData PCA - Kmeans + GMM Neural Network Accuracy curve with number of clusters")
plt.xlabel("No Of Clusters")
plt.ylabel("NN Accuracy")
plt.grid()
