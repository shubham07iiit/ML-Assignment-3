...
plt.figure()
plt.title("BankData - Neural Network Accuracy curve with RP")
...
plt.figure()
plt.title("BankData - Corelations Coeff with components in RP")
plt.xlabel("No Of Components")
...
# plt.figure()
# plt.title("BankData RP - Kmeans + GMM Accuracy curve with number of clusters")
...
plt.figure()
plt.title("BankData RP - Kmeans + GMM Neural Network Accuracy curve with number of clusters")
plt.xlabel("No Of Clusters")
plt.ylabel("NN Accuracy")
plt.grid()
