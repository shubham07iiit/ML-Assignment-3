...
print(max_index)
plt.figure()
plt.title("ImageData - Neural Network Accuracy curve with ICA")
...
plt.figure()
plt.title("ImageData - Kurtosis curve with ICA")
plt.xlabel("No of Components")
plt.ylabel("Kurtosis")
plt.grid()
# plt.xticks(list(range(1,101)))
...
ica = FastICA(n_components=max_index)
ica.fit(data_train)
...
plt.title("ImageData ICA - Kmeans + GMM Accuracy curve with number of clusters")
...
plt.figure()
plt.xticks(list(range(1,30)))
plt.title("ImageData ICA - Kmeans + GMM Neural Network Accuracy curve with number of clusters")
plt.xlabel("No Of Clusters")
plt.ylabel("NN Accuracy")
plt.grid()
